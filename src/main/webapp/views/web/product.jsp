        ...
        <div class="col-12 col-lg-6 add_to_cart_block">
            <div class="card bg-light mb-3">
                <div class="card-body">
                    ...
                    <p class="price">${productByID.productPrice} $</p>
                    <p class="price_discounted">${productByID.productPrice * 1.2} $</p>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="productModalLabel">${productByID.productName} </h5>
